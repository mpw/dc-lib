 ...
 *  Last changed:   $Date: 2011/04/02 13:02:19 $
                     ...
                     LNodeInfo** outDistArray, LNodeInfo** outPredArray) 
{
    ...
    Try {
        ...
        LGraph_ForAllNodes(inGraph, theNode) {
			LNodeInfo_UI4At(*outDistArray, theNode) = _INF;
        ...
        while (!LHeap_Empty(thePQ)) {
            ...
            LGraph_ForAllOut(theNode, theEdge) {
				...
				if (LEdgeInfo_UI4At(inWeightArray, theEdge) == _INF)
					theAdjDist = _INF;
                ...
                if (theAdjDist < LNodeInfo_UI4At(*outDistArray, theAdjNode)) {
                    ...
                    if (LNodeInfo_UI4At(*outDistArray, theAdjNode) == _INF) 

...
/* PUBLIC FUNCTIONS */
LGraph*     LGraphUtil_RandomNM          (ui4 n, ui4 m, ui4 inSeed);
LGraph*     LGraphUtil_RandomUNM         (ui4 n, ui4 m, ui4 inSeed);
LGraph*     LGraphUtil_RandomNP          (ui4 n, f4 p, ui4 inSeed);
LGraph*     LGraphUtil_RandomUNP         (ui4 n, f4 p, ui4 inSeed);
LGraph*     LGraphUtil_Grid              (ui4 n, Bool inDirected);
LGraph*     LGraphUtil_RandomClustered   (ui4 n, ui4 inC, f4 inPc, f4 inPi, ui4 inSeed, Bool inDirected);

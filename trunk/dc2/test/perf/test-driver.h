 ...
 *  Last changed:   $Date: 2011/03/05 10:48:22 $
...
#ifndef CONV
#define CONV 0              // if 1, from-scratch conventional 
...
#ifndef OPT
#define OPT "n/a"           // optimization flag "O0", "O3", etc. 
                            // (defined by makefile)
#endif

#ifndef DC
#define DC 0                // if 1, allow dc-based programs to write 
                            // additional info to log file
#endif
...
#define MAKE_ASM_DUMP 0     // if 1 and DC == 1, write binary dump of dc
                            // app before and after code patching
#endif
